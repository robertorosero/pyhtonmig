...
\date{28 April 1994 \\ Release 1.0.2} % XXX update before release!
...
Reference for a full description; here are some examples:

XXX

\section{Generalized Dictionaries}

XXX keys can be numbers, tuples, some class instances

XXX methods values(), items()

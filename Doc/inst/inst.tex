...
\begin{tableiv}{l|l|l|c}{textrm}%
  ...
  \lineiv{\UNIX{} (pure)}
          {\filenq{\filevar{prefix}/lib/python2.3/site-packages}}
          {\filenq{/usr/local/lib/python2.3/site-packages}}
          {(1)}
  \lineiv{\UNIX{} (non-pure)}
          {\filenq{\filevar{exec-prefix}/lib/python2.3/site-packages}}
          {\filenq{/usr/local/lib/python2.3/site-packages}}
          {(1)}
  \lineiv{Windows}
...
\file{python23.lib} into the Borland format.  You can do this as
follows:
...
\file{python23.lib} is in the \file{Libs} directory of your Python
...
\file{python23.lib}. (Should be the \file{libs} directory under your

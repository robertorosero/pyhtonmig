...
class BaseTestAPI(unittest.TestCase):
    ...
    def test_set_reuse_addr(self):
        ...
        try:
            ...
            unittest.skip("SO_REUSEADDR not supported")
        else:
...
class BaseTestAPI_UseSelect(BaseTestAPI):
    use_poll = False

class BaseTestAPI_UsePoll(BaseTestAPI):
    use_poll = True


def test_main():
    tests = [HelperFunctionTests, DispatcherTests, DispatcherWithSendTests,
             DispatcherWithSendTests_UsePoll, BaseTestAPI_UseSelect]
    if hasattr(asyncore, 'file_wrapper'):
        tests.append(FileWrapperTest)
    if hasattr(select, 'poll'):
        tests.append(BaseTestAPI_UsePoll)

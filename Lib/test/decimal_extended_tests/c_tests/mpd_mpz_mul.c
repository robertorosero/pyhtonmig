...
/*
 * Test mpd_mul against mpz_mul, for all possible factor lengths
 * (in decimal digits) from 1x1 upto (WORDS*MPD_RDIGITS)*(WORDS*MPD_RDIGITS).
 */

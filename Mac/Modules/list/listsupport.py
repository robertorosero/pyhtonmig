...
ListHandle = OpaqueByValueType("ListHandle", "ListObj") # Old name
ListRef = OpaqueByValueType("ListRef", "ListObj")
Cell = OpaqueByValueType("Cell", "PyMac_BuildPoint", "PyMac_GetPoint")
Cell_ptr = OpaqueType("Cell", "PyMac_BuildPoint", "PyMac_GetPoint")
ListBounds = OpaqueByValueType("ListBounds", "PyMac_BuildPoint", "PyMac_GetPoint")
ListBounds_ptr = OpaqueType("ListBounds", "PyMac_BuildPoint", "PyMac_GetPoint")

...
static PyMethodDef Drag_methods[] = {
	...
	{"AddDragItemFlavor", (PyCFunction)Drag_AddDragItemFlavor, 1,
	 "(DragRef theDrag, DragItemRef theItemRef, FlavorType theType, Buffer dataPtr, FlavorFlags theFlags) -> None"},
	{"SetDragItemFlavorData", (PyCFunction)Drag_SetDragItemFlavorData, 1,
	 "(DragRef theDrag, DragItemRef theItemRef, FlavorType theType, Buffer dataPtr, UInt32 dataOffset) -> None"},
	...
	{"GetDragItemReferenceNumber", (PyCFunction)Drag_GetDragItemReferenceNumber, 1,
	 "(DragRef theDrag, UInt16 index) -> (DragItemRef theItemRef)"},
	{"CountDragItemFlavors", (PyCFunction)Drag_CountDragItemFlavors, 1,
	 "(DragRef theDrag, DragItemRef theItemRef) -> (UInt16 numFlavors)"},
	{"GetFlavorType", (PyCFunction)Drag_GetFlavorType, 1,
	 "(DragRef theDrag, DragItemRef theItemRef, UInt16 index) -> (FlavorType theType)"},
	{"GetFlavorFlags", (PyCFunction)Drag_GetFlavorFlags, 1,
	 "(DragRef theDrag, DragItemRef theItemRef, FlavorType theType) -> (FlavorFlags theFlags)"},
	{"GetFlavorDataSize", (PyCFunction)Drag_GetFlavorDataSize, 1,
	 "(DragRef theDrag, DragItemRef theItemRef, FlavorType theType) -> (Size dataSize)"},
	{"GetFlavorData", (PyCFunction)Drag_GetFlavorData, 1,
	 "(DragRef theDrag, DragItemRef theItemRef, FlavorType theType, Buffer dataPtr, UInt32 dataOffset) -> (Buffer dataPtr)"},
	{"GetDragItemBounds", (PyCFunction)Drag_GetDragItemBounds, 1,
	 "(DragRef theDrag, DragItemRef theItemRef) -> (Rect itemBounds)"},
	{"SetDragItemBounds", (PyCFunction)Drag_SetDragItemBounds, 1,
	 "(DragRef theDrag, DragItemRef theItemRef, Rect itemBounds) -> None"},

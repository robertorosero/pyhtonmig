...
TimeBaseFlags = Type("TimeBaseFlags", "k")
QTCallBackFlags = Type("QTCallBackFlags", "H")
TimeBaseStatus = Type("TimeBaseStatus", "k")
QTCallBackType = Type("QTCallBackType", "H")
nextTimeFlagsEnum = Type("nextTimeFlagsEnum", "H")
createMovieFileFlagsEnum = Type("createMovieFileFlagsEnum", "k")
movieFlattenFlagsEnum = Type("movieFlattenFlagsEnum", "k")
dataRefAttributesFlags = Type("dataRefAttributesFlags", "k")
playHintsEnum = Type("playHintsEnum", "k")
mediaHandlerFlagsEnum = Type("mediaHandlerFlagsEnum", "k")
ComponentResult = Type("ComponentResult", "k")
HandlerError = Type("HandlerError", "k")
Ptr = InputOnlyType("Ptr", "s")
StringPtr = Type("StringPtr", "s")
mcactionparams = InputOnlyType("void *", "s")
QTParameterDialog = Type("QTParameterDialog", "k")
QTAtomID = Type("QTAtomID", "k")
MCInterfaceElement = Type("MCInterfaceElement", "k")

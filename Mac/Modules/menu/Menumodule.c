...
typedef int MenuAttributes;
typedef int MenuItemAttributes;
typedef unsigned short MenuItemIndex;
typedef int MenuCommand;
typedef short FMFontFamily;
typedef short FMFontStyle;
typedef short FMFontSize;
...
static PyObject *MenuObj_GetMenuItemPropertySize(_self, _args)
	MenuObject *_self;
	PyObject *_args;
{
	PyObject *_res = NULL;
	...
	if (!PyArg_ParseTuple(_args, "HO&O&",
		...
		return NULL;
	_err = GetMenuItemPropertySize(_self->ob_itself,
	                               item,
	                               propertyCreator,
	                               propertyTag,
	                               &size);
...
static PyObject *MenuObj_RemoveMenuItemProperty(_self, _args)
	MenuObject *_self;
	PyObject *_args;
{
	PyObject *_res = NULL;
	...
	if (!PyArg_ParseTuple(_args, "HO&O&",
	                      ...
	                      PyMac_GetOSType, &propertyTag))
		return NULL;
	_err = RemoveMenuItemProperty(_self->ob_itself,
	                              item,
	                              propertyCreator,
	                              propertyTag);
	if (_err != noErr) return PyMac_Error(_err);
...
static PyMethodDef MenuObj_methods[] = {
	...
	{"IsMenuItemIconEnabled", (PyCFunction)MenuObj_IsMenuItemIconEnabled, 1,
	 "(MenuItemIndex item) -> (Boolean _rv)"},
	{"GetMenuItemPropertySize", (PyCFunction)MenuObj_GetMenuItemPropertySize, 1,
	 "(MenuItemIndex item, OSType propertyCreator, OSType propertyTag) -> (UInt32 size)"},
	{"RemoveMenuItemProperty", (PyCFunction)MenuObj_RemoveMenuItemProperty, 1,
	 "(MenuItemIndex item, OSType propertyCreator, OSType propertyTag) -> None"},

# Generated from 'Macintosh HD:SWDev:Codewarrior 6 MPTP:Metrowerks CodeWarrior:MacOS Support:Universal:Interfaces:CIncludes:Icons.h'
...
kAppleExtrasFolderIcon = FOUR_CHAR_CODE('aexü')
...
kAssistantsFolderIcon = FOUR_CHAR_CODE('astü')
...
kControlStripModulesFolderIcon = FOUR_CHAR_CODE('sdvü')
...
kHelpFolderIcon = FOUR_CHAR_CODE('ühlp')
kInternetFolderIcon = FOUR_CHAR_CODE('intü')
kInternetPlugInFolderIcon = FOUR_CHAR_CODE('ünet')
kLocalesFolderIcon = FOUR_CHAR_CODE('üloc')
kMacOSReadMeFolderIcon = FOUR_CHAR_CODE('morü')
kPreferencesFolderIcon = FOUR_CHAR_CODE('prfü')
kPrinterDescriptionFolderIcon = FOUR_CHAR_CODE('ppdf')
kPrinterDriverFolderIcon = FOUR_CHAR_CODE('üprd')
...
kScriptingAdditionsFolderIcon = FOUR_CHAR_CODE('üscr')
kSharedLibrariesFolderIcon = FOUR_CHAR_CODE('ülib')
kScriptsFolderIcon = FOUR_CHAR_CODE('scrü')
...
kTextEncodingsFolderIcon = FOUR_CHAR_CODE('ütex')
kAppearanceFolderIcon = FOUR_CHAR_CODE('appr')
kUtilitiesFolderIcon = FOUR_CHAR_CODE('utiü')
...
kUsersFolderIcon = FOUR_CHAR_CODE('usrü')
